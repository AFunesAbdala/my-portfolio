...
export default function AboutMeComponent() {
    ...
    return (
        ...
        >
            <Element name="about_me" className="w-full h-screen flex items-center justify-between">
                <motion.h1
                    initial="hidden"
                    animate={controls}
                    variants={{
                    ...
                    className="font-darkerGrotesque font-bold text-gray-800 text-6xl leading-[50px] w-20"
                >About Me</motion.h1>
                <motion.div
                    initial="hidden"
                    animate={controls}
                    ...
                    className="w-4/6 bg-white rounded-3xl p-8"
                >
